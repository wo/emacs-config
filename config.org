...
This tweak is from [[http://doc.norang.ca/org-mode.html#StrikeThroughEmphasis][Bernt Hansen's notes]]. 
...
(after! citar
  ...
  (add-to-list 'citar-templates '(note . "${author editor} ${date year issued:4} ${title}"))
  )
#+end_src
