...
(setq +zen-text-scale 0.9
      ...
      doom-variable-pitch-font (font-spec :family "Source Sans Pro" :size 20 :weight regular)
...
(map!
 :leader
 :desc "add org-roam tag" "n t" #'+org-roam-tag-add
 :desc "remove org-roam tag" "n T" #'+org-roam-tag-remove
)
#+end_src
